...
export interface Event {
  ...
  eventDate: Date; // the actual event date (added)
  state: "opened" | "closed";
...
export const eventsData: Event[] = [
  {
    ...
    eventDate: new Date("2025-09-06"), // hardcoded
    state: "opened",
    approval: "accepted",
    totalSeats: 200,
    image: event1,
  },
  {
    ...
    eventDate: new Date("2025-09-12"), // hardcoded
    state: "opened",
    approval: "accepted",
    totalSeats: 500,
    image: event2,
  },
  {
    ...
    eventDate: new Date("2025-09-20"), // hardcoded
    state: "closed",
    approval: "rejected",
    totalSeats: 150,
    image: event3,
  },
  {
    ...
    eventDate: new Date("2025-10-01"), // hardcoded
    state: "opened",
    approval: "accepted",
    totalSeats: 50,
    image: event4,
  },
  {
    ...
    eventDate: new Date("2025-10-05"), // hardcoded
    state: "opened",
    approval: "accepted",
    totalSeats: 30,
    image: event5,
  },
  {
    ...
    eventDate: new Date("2025-10-18"), // hardcoded
    state: "opened",
    approval: "accepted",
    totalSeats: 1000,
    image: event6,
