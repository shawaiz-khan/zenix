...
const Hero: React.FC = () => {
    return (
        <section className="bg-bg-light min-h-96 max-h-screen p-5 md:py-5 md:px-28 flex flex-col md:flex-row justify-center md:justify-between items-center gap-5">
            <img
                src={hero_img}
            ...
            <div className="flex flex-col gap-4">
                ...
                <p className="hidden md:block max-w-xl text-primary/60">
